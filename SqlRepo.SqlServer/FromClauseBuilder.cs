...
namespace SqlRepoEx.SqlServer
{
    public class FromClauseBuilder : ClauseBuilder, IFromClauseBuilder
    {
        ...
        public IFromClauseBuilder From<TEntity>(TableAlias alias,
                  string tableName = null,
                  string tableSchema = null)
        {
            ...
            string rightTableSchema = null)
        {
            ...
            return InnerJoin<TLeft, TRight>(Utils.Alias(leftTableAlias), Utils.Alias(rightTableAlias), rightTableName, rightTableSchema);
        }

        public IFromClauseBuilder LeftOuterJoin<TLeft, TRight>(TableAlias leftTableAlias,
           TableAlias rightTableAlias,
           string rightTableName = null,
           string rightTableSchema = null)
        {
            return LeftOuterJoin<TLeft, TRight>(Utils.Alias(leftTableAlias), Utils.Alias(rightTableAlias), rightTableName, rightTableSchema);
        }
           ...
           TableAlias rightTableAlias)
        {
            ...
            return On<TLeft, TRight>(expression, Utils.Alias(leftTableAlias), Utils.Alias(rightTableAlias));
        }

        public IFromClauseBuilder RightOuterJoin<TLeft, TRight>(TableAlias leftTableAlias,
           TableAlias rightTableAlias,
            string rightTableName = null,
            string rightTableSchema = null)
        {

            return RightOuterJoin<TLeft, TRight>(Utils.Alias(leftTableAlias), Utils.Alias(rightTableAlias), rightTableName, rightTableSchema); ;
        }
        #endregion
