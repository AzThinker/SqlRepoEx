...
namespace SqlRepoEx.SqlServer
{
    public class GroupByClauseBuilder : ClauseBuilder, IGroupByClauseBuilder
    {
           ...
           params Expression<Func<TEntity, object>>[] additionalSelectors)
        {
            ...
            return By<TEntity>(selector, Utils.Alias(alias), tableName, tableSchema, additionalSelectors);
        }
          ...
          string tableSchema = null)
        {
            ...
            return HavingAvg<TEntity>(selector, comparison, value, Utils.Alias(alias), tableName, tableSchema);
        }
            ...
            string tableSchema = null)
        {
            ...
            return HavingCount<TEntity>(selector, comparison, value, Utils.Alias(alias), tableName, tableSchema);
        }
            ...
            string tableSchema = null)
        {
            ...
            return HavingMax<TEntity>(selector, comparison, value, Utils.Alias(alias), tableName, tableSchema);
        }
            ...
            string tableSchema = null)
        {
            ...
            return HavingMin<TEntity>(selector, comparison, value, Utils.Alias(alias), tableName, tableSchema);
        }
            ...
            string tableSchema = null)
        {
            ...
            return HavingSum<TEntity>(selector, comparison, value, Utils.Alias(alias), tableName, tableSchema);
        }
        #endregion
